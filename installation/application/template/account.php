...
require_once(dirname(dirname(dirname(dirname(__FILE__)))).'/system/start.php');	 

?>
<div class="layout-installation">
<h2> <?php echo bframework_print('create:admin:account');?> </h2>
<form action="<?php echo bframework_get_url();?>action/account" method="post">
<div>
