...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function b(e, t, n, r) {
            var i, o, a, s, l, c = u(e);
            if (!r && 1 === c.length) {
                if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && H && _.relative[o[1].type]) {
            ...
            return k(e, c)(r, t, !H, n, ht.test(e)), n
        }

        function C() {
        }

        var x, w, _, N, E, k, S, T, R, A, B, L, H, D, M, P, O, I = "sizzle" + -new Date, F = window.document, z = {}, W = 0, V = 0, U = n(), q = n(), $ = n(), j = !1, K = function () {
            return 0
        ...
        E = o.isXML = function (e) {
            ...
            return r !== B && 9 === r.nodeType && r.documentElement ? (B = r, L = r.documentElement, H = !E(r), z.getElementsByTagName = i(function (e) {
                ...
                if (typeof n.getElementById !== G && H) {
            ...
            }, M = [], D = [":focus"], (z.qsa = e(r.querySelectorAll)) && (i(function (e) {
                e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || D.push("\\[" + nt + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"), e.querySelectorAll(":checked").length || D.push(":checked")
            }), i(function (e) {
                e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length && D.push("[*^$]=" + nt + "*(?:\"\"|'')"), e.querySelectorAll(":enabled").length || D.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), D.push(",.*:")
            ...
            }), D = new RegExp(D.join("|")), M = M.length && new RegExp(M.join("|")), O = e(L.contains) || L.compareDocumentPosition ? function (e, t) {
            ...
            if ((e.ownerDocument || e) !== B && A(e), t = t.replace(Ct, "='$1']"), z.matchesSelector && H && (!M || !M.test(t)) && !D.test(t))try {
                var n = P.call(e, t);
            ...
            var n;
            return (e.ownerDocument || e) !== B && A(e), H && (t = t.toLowerCase()), (n = _.attrHandle[t]) ? n(e) : !H || z.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
        }, o.error = function (e) {
        ...
        function t(n) {
            ...
            function E(e) {
                ...
                if (3 == D[V].nodeType) {
                    if (n = D[V].nodeValue, i = n.substring(D[W], D[q]), e != O && (o = D[V], c = D[W], u = D[q] - D[W], 0 === c && u >= o.nodeValue.length - 1 ? o.parentNode.removeChild(o) : o.deleteData(c, u), D.collapse(F)), e == I)return;
            ...
            function k(e, t) {
                var n, i, o, a, s, l;
                if (t != I && (n = r()), i = R(e, t), n && n.appendChild(i), o = j(e), a = o - D[W], 0 >= a)return t != O && (D.setEndBefore(e), D.collapse(z)), n;
            ...
            function S(e, t) {
                var n, i, o, a, s, l;
                for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = j(e), ++i, a = D[q] - i, o = e.nextSibling; o && a > 0;)s = o.nextSibling, l = L(o, t), n && n.appendChild(l), --a, o = s;
            ...
            var D = this, M = n.doc, P = 0, O = 1, I = 2, F = !0, z = !1, W = "startOffset", V = "startContainer", U = "endContainer", q = "endOffset", $ = e.extend, j = n.nodeIndex;
            return $(D, {
                startContainer: M,
                startOffset: 0,
                endContainer: M,
        ...
        return function (i, o) {
            ...
            i = i || {}, a.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var s = this, l, c = 0, u, d, f = [], p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, H, D, M, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href"), V = /(java|vb)script:/i;
                for (D = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), M = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, b = o.getShortEndedElements(), H = i.self_closing_elements || o.getSelfClosingElements(), C = o.getBoolAttrs(), w = i.validate, y = i.remove_internals, z = i.fix_self_closing, P = o.getSpecialElements(); l = D.exec(e);) {
                    if (c < l.index && s.text(F(e.substr(c, l.index - c))), u = l[6])u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), r(u); else if (u = l[7]) {
                        if (u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), x = u in b, z && H[u] && f.length > 0 && f[f.length - 1].name === u && r(u), !w || (_ = o.getElementRule(u))) {
                        ...
                        if (d = P[u]) {
                            d.lastIndex = c = l.index + l[0].length, (l = d.exec(e)) ? (N && (m = e.substr(c, l.index - c)), c = l.index + l[0].length) : (m = e.substr(c), c = e.length), N && (m.length > 0 && s.text(m, !0), s.end(u)), D.lastIndex = c;
                            continue
                        }
        ...
        return function (r, i) {
            ...
            function a(t) {
                var n, r;
                n = t.screenX - k, r = t.screenY - S, D = n * N[2] + A, M = r * N[3] + B, D = 5 > D ? 5 : D, M = 5 > M ? 5 : M, (e.modifierPressed(t) || "IMG" == x.nodeName && N[2] * N[3] !== 0) && (D = Math.round(M / L), M = Math.round(D * L)), b.setStyles(w, {
                    width: D,
                    height: M
                }), N[2] < 0 && w.clientWidth <= D && b.setStyle(w, "left", T + (A - D)), N[3] < 0 && w.clientHeight <= M && b.setStyle(w, "top", R + (B - M)), H || (i.fire("ObjectResizeStart", {
                    target: x,
                    width: A,
                    height: B
                }), H = !0)
            ...
            function s() {
                ...
                H = !1, e("width", D), e("height", M), b.unbind(P, "mousemove", a), b.unbind(P, "mouseup", s), O != P && (b.unbind(O, "mousemove", a), b.unbind(O, "mouseup", s)), b.remove(w), I && "TABLE" != x.nodeName || l(x), i.fire("ObjectResized", {
                    target: x,
                    width: D,
                    height: M
                }), i.nodeChanged()
            ...
            function l(e, t, n) {
                ...
                r = b.getPos(e, p), T = r.x, R = r.y, f = e.getBoundingClientRect(), l = f.width || f.right - f.left, u = f.height || f.bottom - f.top, x != e && (m(), x = e, D = M = 0), d = i.fire("ObjectSelected", {target: e}), o(e) && !d.isDefaultPrevented() ? C(_, function (e, r) {
                    function o(t) {
                        H = !0, k = t.screenX, S = t.screenY, A = x.clientWidth, B = x.clientHeight, L = B / A, N = e, w = x.cloneNode(!0), b.addClass(w, "mce-clonedresizable"), w.contentEditable = !1, w.unSelectabe = !0, b.setStyles(w, {
                            left: T,
                            top: R,
                            margin: 0
            ...
            setCursorLocation: function (e, t) {
                ...
                function t(t) {
                    ...
                    if (c = r[(t ? "start" : "end") + "Container"], u = r[(t ? "start" : "end") + "Offset"], m = f.schema.getNonEmptyElements(), 9 === c.nodeType && (c = f.getRoot(), u = 0), c === p) {
                        if (t && (h = c.childNodes[u > 0 ? u - 1 : 0], h && (g = h.nodeName.toLowerCase(), m[h.nodeName] || "TABLE" == h.nodeName)))return;
        ...
        return function (r) {
            ...
            function h(e, t, n) {
                ...
                function f(e) {
                    ...
                    e = T(e, p, G), h.split && (t = D(e, G), n = D(e), t != n ? (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), o && /^T(HEAD|BODY|FOOT|R)$/.test(o.nodeName) && /^(TH|TD)$/.test(n.nodeName) && n.firstChild && (n = n.firstChild || n), t = S(t, "span", {
                        id: "_start",
                        "data-mce-type": "bookmark"
                    }), n = S(n, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    }), l(t), l(n), t = u(G), n = u()) : t = n = l(t), e.startContainer = t.parentNode, e.startOffset = q(t), e.endContainer = n.parentNode, e.endOffset = q(n) + 1), z.walk(e, function (e) {
                        et(e, function (e) {
            ...
            function b(e) {
                ...
                if (t)for (n = F.getStart(), r = o(n), a = t.length - 1; a >= 0; a--) {
                    if (s = t[a].selector, !s || t[a].defaultBlock)return G;
            ...
            function A(e, t) {
                ...
                })) : V(e) && !V(i) && (n(e, K) || n(e.firstChild, G, 1) || e.insertBefore(I.create("br"), e.firstChild), n(e, G) || n(e.lastChild, K, 1) || e.appendChild(I.create("br")))), t.selector && t.inline && !w(t.inline, e) || I.remove(e, 1)
            }
            ...
            var O = {}, I = r.dom, F = r.selection, z = new t(I), W = r.schema.isValidChild, V = I.isBlock, U = r.settings.forced_root_block, q = I.nodeIndex, $ = "\ufeff", j = /^(src|href|style)$/, K = !1, G = !0, Y, X, J = I.getContentEditable, Q, Z, et = n.each, tt = n.grep, nt = n.walk, rt = n.extend;
            rt(this, {
                get: c,
                register: u,
                apply: p,
        ...
        return function (r) {
            ...
            o(this, {
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    if (_.isCollapsed()) {
                        var t = _.getNode();
                        return "A" == t.tagName && r.dom.remove(t, !0), void 0
                    }
                    v(e), _.collapse(f)
        ...
        return function (a) {
            ...
            function u() {
                function t(e) {
                    ...
                    if (n.collapsed || (e = !0), l = n[(e ? "start" : "end") + "Container"], c = n[(e ? "start" : "end") + "Offset"], 3 == l.nodeType && (r = W.getParent(n.startContainer, W.isBlock), e && (r = W.getNext(r, W.isBlock)), !r || !t() && n.collapsed || (i = W.create("em", {id: "__mceDel"}), I(o.grep(r.childNodes), function (e) {
                            i.appendChild(e)
                        }), r.appendChild(i))), n = W.createRng(), n.setStart(d[0], d[1]), n.setEnd(d[2], d[3]), V.setRng(n), a.getDoc().execCommand(e ? "ForwardDelete" : "Delete", !1, null), i) {
                        for (s = V.getBookmark(); u = W.get("__mceDel");)W.remove(u, !0);
                        V.moveToBookmark(s)
                    }
                }
                ...
                a.on("keydown", function (n) {
                    var r;
                    r = n.keyCode == z, c(n) || !r && n.keyCode != F || e.modifierPressed(n) || (n.preventDefault(), t(r))
            ...
            function p() {
                a.settings.content_editable || (W.bind(a.getDoc(), "focusin", function () {
                    ...
                    e.target == a.getDoc().documentElement && (a.getWin().focus(), V.setRng(V.getRng()))
                }))
            }

            function h() {
                a.on("keydown", function (e) {
                    if (!c(e) && e.keyCode === F && V.isCollapsed() && 0 === V.getRng(!0).startOffset) {
                        var t = V.getNode(), n = t.previousSibling;
                        if ("HR" == t.nodeName)return W.remove(t), e.preventDefault(), void 0;
            ...
            function _() {
                a.on("keydown", function (t) {
                    var n, r, i, o, s, l, u, d;
                    if (n = t.keyCode == z, !c(t) && (n || t.keyCode == F) && !e.modifierPressed(t) && (r = V.getRng(), i = r.startContainer, o = r.startOffset, u = r.collapsed, 3 == i.nodeType && i.nodeValue.length > 0 && (0 === o && !u || u && o === (n ? 0 : 1)))) {
                        if (l = i.previousSibling, l && "IMG" == l.nodeName)return;
                        d = a.schema.getNonEmptyElements(), t.preventDefault(), s = W.create("br", {id: "__tmp"}), i.parentNode.insertBefore(s, i), a.getDoc().execCommand(n ? "ForwardDelete" : "Delete", !1, null), i = V.getRng().startContainer, l = i.previousSibling, l && 1 == l.nodeType && !W.isBlock(l) && W.isEmpty(l) && !d[l.nodeName.toLowerCase()] && W.remove(l), W.remove("__tmp")
                    }
                })
            }
            ...
            function R() {
                a.on("keydown", function (e) {
                    var t;
                    c(e) || e.keyCode != F || (t = a.getDoc().selection.createRange(), t && t.item && (e.preventDefault(), a.undoManager.beforeChange(), W.remove(t.item(0)), a.undoManager.add()))
                })
            }
            ...
            function B() {
                ...
                }), $.addNodeFilter("noscript", function (e) {
            ...
            var I = o.each, F = e.BACKSPACE, z = e.DELETE, W = a.dom, V = a.selection, U = a.settings, q = a.parser, $ = a.serializer, j = i.gecko, K = i.ie, G = i.webkit;
            C(), N(), d(), H(), G && (_(), u(), p(), g(), S(), i.iOS ? (y(), M(), P()) : f()), K && i.ie < 11 && (h(), b(), x(), w(), R(), A(), B(), L()), i.ie >= 11 && P(), i.ie && f(), j && (h(), m(), v(), E(), k(), T(), D(), O())
        }
    }), r(nt, [p], function (e) {
        function t() {
            return !1
    ...
    }), r(it, [v, b, C, k, E, A, L, H, D, M, P, O, y, l, et, x, _, tt, g, p, nt, rt], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        var E = e.DOM, k = n.ThemeManager, S = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray, L = C.trim, H = C.resolve, D = h.Event, M = b.gecko, P = b.ie;
        return N.prototype = {
            render: function () {
                function e() {
        ...
        function n(r) {
            ...
            function s(s) {
                ...
                var u = s.editor, d, f;
                u.on("init", function () {
                    "onbeforedeactivate"in document && t.ie < 11 ? u.dom.bind(u.getBody(), "beforedeactivate", function () {
                        var e = u.getDoc().selection;
                        try {
                            d = e && e.createRange ? e.createRange() : u.selection.getRng()
                        } catch (t) {
                        }
                    }) : (u.inline || t.ie > 10) && (u.on("nodechange keyup", function () {
                        var e = document.activeElement;
                        e && e.id == u.id + "_ifr" && (e = u.getBody()), c(e) && (d = u.selection.getRng())
                    }), t.webkit && (f = function () {
                        var e = u.selection.getRng();
                        e.collapsed || (d = e)
                    }, e.DOM.bind(document, "selectionchange", f), u.on("remove", function () {
                        e.DOM.unbind(document, "selectionchange", f)
                    })))
                    ...
                    u.selection.lastFocusBookmark && (u.selection.setRng(a(u, u.selection.lastFocusBookmark)), u.selection.lastFocusBookmark = null), e != u && (e && e.fire("blur", {focusedEditor: u}), r.activeEditor = u, u.fire("focus", {blurredEditor: e}), u.focus(!1), r.focusedEditor = u), d = null
                }), u.on("focusout", function (e) {
                    e.target !== u.getBody() && c(e.target) || (u.selection.lastFocusBookmark = o(d), window.setTimeout(function () {
                        var e = r.focusedEditor;
                        e != u && (u.selection.lastFocusBookmark = null), l(i()) || e != u || (u.fire("blur", {focusedEditor: null}), r.focusedEditor = null, u.selection.lastFocusBookmark = null)
                    }, 0))
                })
            }
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v = [], y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, H, D, M, P, O, I, F, z, W, V = Math.max, U = Math.min;
    ...
    }), r(Dt, [V, yt, X, p, st, g], function (e, t, n, r, i, o) {
        function a(e) {
            function t(t) {
                function n(e) {
        ...
        return e.extend({
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    if (D)for (d = 0; d < D.length; d++)H += D[d]; else H = r;
                    var M = A / H;
                    for (d = 0; r > d; d++)N[d] += D ? D[d] * M : M;
    ...
    }), a([l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, H, D, M, P, O, I, F, z, W, V, U, q, $, j, K, G, Y, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, kt, St, Tt, Rt, At, Bt, Lt, Ht, Dt, Mt, Pt, Ot, It, Ft, zt, Wt, Vt, Ut, qt, $t, jt, Kt, Gt, Yt, Xt, Jt])
}(this);