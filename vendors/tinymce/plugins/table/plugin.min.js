!function (e, t) {
    ...
    r(l, [c, d], function (e, t) {
        ...
        return function (i, o) {
            function a() {
                ...
                R = [], r(["thead", "tbody", "tfoot"], function (t) {
                    var i = M.select("> " + t + " tr", o);
                    r(i, function (i, o) {
                        o += e, r(M.select("> td, > th", i), function (e, r) {
                            var i, a, s, l;
                            if (R[o])for (; R[o][r];)r++;
            ...
            function d(e) {
                return e && (M.hasClass(e.elm, "mce-item-selected") || e == L)
            }
            ...
            function u() {
                ...
                return r(o.rows, function (t) {
                    r(t.cells, function (n) {
                        return M.hasClass(n, "mce-item-selected") || n == L.elm ? (e.push(t), !1) : void 0
                    })
                }), e
            }
            ...
            function f() {
                var e = M.createRng();
                e.setStartAfter(o), e.setEndAfter(o), H.setRng(e), M.remove(o)
            }
            ...
            function p(n) {
                ...
                return i.settings.table_clone_elements !== !1 && (a = e.makeMap((i.settings.table_clone_elements || "strong em b i span font h1 h2 h3 h4 h5 h6 p div").toUpperCase(), /[ ,]/)), e.walk(n, function (e) {
                    var i;
                    return 3 == e.nodeType ? (r(M.getParents(e.parentNode, null, n).reverse(), function (e) {
            ...
            function m() {
                var e = M.createRng(), t;
                return r(M.select("tr", o), function (e) {
                    0 === e.cells.length && M.remove(e)
                }), 0 === M.select("tr", o).length ? (e.setStartBefore(o), e.setEndBefore(o), H.setRng(e), M.remove(o), void 0) : (r(M.select("thead,tbody,tfoot", o), function (e) {
                    0 === e.rows.length && M.remove(e)
                }), a(), t = R[Math.min(R.length - 1, A.y)], t && (H.select(t[Math.min(t.length - 1, A.x)].elm, !0), H.collapse(!0)), void 0)
            }

            function h(e, t, n, r) {
                var i, o, a, s, l;
                for (i = R[t][e].elm.parentNode, a = 1; n >= a; a++)if (i = M.getNext(i, "tr")) {
                    for (o = e; o >= 0; o--)if (l = R[t + a][o].elm, l.parentNode == i) {
                        for (s = 1; r >= s; s++)M.insertAfter(p(l), l);
                        break
                    }
                ...
                r(R, function (e, t) {
                    r(e, function (e, r) {
                        ...
                        if (d(e) && (e = e.elm, i = n(e, "colspan"), o = n(e, "rowspan"), i > 1 || o > 1)) {
                            for (c(e, "rowSpan", 1), c(e, "colSpan", 1), a = 0; i - 1 > a; a++)M.insertAfter(p(e), e);
                            h(r, t, o - 1, i)
                        }
                    })
                })
            ...
            function v(t, n, i) {
                ...
                if (t ? (o = E(t), s = o.x, u = o.y, f = s + (n - 1), p = u + (i - 1)) : (A = B = null, r(R, function (e, t) {
                    ...
                    for (g(), a(), y = l(s, u).elm, c(y, "colSpan", f - s + 1), c(y, "rowSpan", p - u + 1), v = u; p >= v; v++)for (h = s; f >= h; h++)R[v] && R[v][h] && (t = R[v][h].elm, t != y && (C = e.grep(t.childNodes), r(C, function (e) {
                        ...
                        "BR" == e.nodeName && M.getAttrib(e, "data-mce-bogus") && x++ < C.length - 1 && y.removeChild(e)
                    })), M.remove(t)));
                    m()
                }
            }
            ...
            function y(e) {
                ...
                u.hasChildNodes() && (e ? l.parentNode.insertBefore(u, l) : M.insertAfter(u, l))
            }
            ...
            function b(e) {
                ...
                r(R, function (n) {
                    ...
                    var a, s, l;
                    r[t] && (a = r[t].elm, a != i && (l = n(a, "colspan"), s = n(a, "rowspan"), 1 == l ? e ? (a.parentNode.insertBefore(p(a), a), h(t, o, s - 1, l)) : (M.insertAfter(p(a), a), h(t, o, s - 1, l)) : c(a, "colSpan", a.colSpan + 1), i = a))
                })
            }
                ...
                r(R, function (i) {
                    r(i, function (i, o) {
                        d(i) && -1 === e.inArray(t, o) && (r(R, function (e) {
                            var t = e[o].elm, r;
                            r = n(t, "colSpan"), r > 1 ? c(t, "colSpan", r - 1) : M.remove(t)
                        }), t.push(o))
                    })
                }), m()
            }
            ...
            function x() {
                function e(e) {
                    var t, i, o;
                    t = M.getNext(e, "tr"), r(e.cells, function (e) {
                        var t = n(e, "rowSpan");
                        t > 1 && (c(e, "rowSpan", t - 1), i = E(e), h(i.x, i.y, 1, 1))
                    }), i = E(e.cells[0]), r(R[i.y], function (e) {
                        var t;
                        e = e.elm, e != o && (t = n(e, "rowSpan"), 1 >= t ? M.remove(e) : c(e, "rowSpan", t - 1), o = e)
                    })
                }
            ...
            function N(e, t) {
                ...
                e && (r(R, function (e) {
                    ...
                    for (n = o; r > n; n++)M.remove(e.cells[n]);
                    t ? i.parentNode.insertBefore(e, i) : M.insertAfter(e, i)
            ...
            function T(e) {
                ...
                if (B = E(e), A && B) {
                    ...
                    for (M.removeClass(M.select("td.mce-item-selected,th.mce-item-selected"), "mce-item-selected"), d = n; a >= d; d++)for (c = t; o >= c; c++)R[d][c] && M.addClass(R[d][c].elm, "mce-item-selected")
                }
            }

            var R, A, B, L, H = i.selection, M = H.dom;
            o = o || M.getParent(H.getStart(), "table"), a(), L = M.getParent(H.getStart(), "th,td"), L && (A = E(L), B = S(), L = l(A.x, A.y)), e.extend(this, {
                deleteTable: f,
                split: g,
                merge: v,
                insertRow: y,
        ...
        return function (n) {
            ...
            t.webkit && (o(), l()), t.gecko && (a(), s()), t.ie > 10 && (a(), s())
        }
