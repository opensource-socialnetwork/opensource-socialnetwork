...
.logo-admin {
background:url('<?php echo ossn_site_url(); ?>themes/default/images/logo_admin.png') no-repeat;
height:57px;
width:187px;
}
.ossn-header .inner{
...
.top-controls-users-page {float:right;}
.top-controls {margin-bottom:10px;margin-top:6px; }
.top-controls a{
margin-right:5px;
}
.user-search {
...
.ossn-admin-menu-topbar  ul li ul li:hover { background: #5B8AAA;
}
