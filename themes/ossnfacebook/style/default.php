...
.ossn-button-submit {
 ...
 -webkit-box-shadow: 3px 1px 0 rgba(0, 0, 0, 0.1), inset 0 1px 0 #89A6C4;
 -moz-box-shadow: 3px 1px 0 rgba(0, 0, 0, 0.10), inset 0 1px 0 #89A6C4;
 box-shadow: 3px 1px 0 rgba(0, 0, 0, 0.1), inset 0 1px 0 #89A6C4;
}
...
.logo-second {
 background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/logo_2.png') no-repeat;
 height:28px;
 width:28px;
}
.ossn-header .inner{
...
.ossn-logo {
 background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/logo.jpg') no-repeat;
 height: 49px;
 width: 166px;
...
.ossn-icons-topbar-notifications-new{
	background: url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/topbar.png') no-repeat;
}
.ossn-icons-topbar-messages{
...
.ossn-loading {
  background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/loading.gif') no-repeat;
  height:24px;
  width:24px; 
}
.ossn-box-loading {
...
.ossn-wall-friend {
   background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/wall/friend.png') no-repeat;
   width:20px;
   height:17px; 
}
.ossn-wall-status {
   background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/wall/status.png') no-repeat;
   width:16px;
   height:16px; 
}
.ossn-wall-location {
   background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/wall/location.png') no-repeat;
   width:20px;
   height:17px; 
}
.ossn-wall-photo {
   background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/wall/photo.png') no-repeat;
   width:17px;
   height:17px; 
}
.ossn-icon-access-friends {
   background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/access/friends.png') no-repeat;
   width:12px;
   height:12px; 
}
.ossn-icon-access-public {
   background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/access/public.png') no-repeat;
   width:12px;
   height:13px; 
}
.ossn-icon-access-private {
   background:url('<?php echo ossn_site_url();?>themes/ossnfacebook/images/icons/access/private.png') no-repeat;
   width:10px;
   height:12px; 
}
.ossn-inline-table {
...
.ossn-button-submit-b{
  background-image:#47639e !important; 
}