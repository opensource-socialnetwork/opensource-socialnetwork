...
$user_liked = '';
if (ossn_isLoggedIn()) { 
         $user_liked = $OssnLikes->isLiked($object, ossn_loggedin_user()->guid); //returns object else boolean false
}
...
if ($count) {
	...
	?>
    <div class="like-share" onclick="Ossn.ViewLikes(<?php echo $object;?>);">
