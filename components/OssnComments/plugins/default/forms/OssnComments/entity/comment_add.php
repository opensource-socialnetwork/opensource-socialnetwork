...
<a href="javascript:void(0);" class="btn btn-primary btn-sm comment-post-btn d-sm-block d-md-none" data-type='e' data-guid='<?php echo $object; ?>'><?php echo ossn_print('post');?></a>      
