...
Ossn.PostComment = function ($container) {
	...
	$('#comment-box-p' + $container).on('drop', function (e) {
		e.preventDefault();

		// Get plain text from the drop dataTransfer object
		var text = (e.originalEvent || e).dataTransfer.getData('text/plain');

		// Fallback if the dropped data doesn't contain standard plain text
		if (!text) {
			return;
		}
...
Ossn.ObjectComment = function ($container) {
	...
	$('#comment-box-o' + $container).on('drop', function (e) {
		e.preventDefault();
...
Ossn.EntityComment = function ($container) {
	...
	$('#comment-box-e' + $container).on('drop', function (e) {
		e.preventDefault();
