 ...
 */
$es = array(
    'user:blocked' => '¡El usuario ha sido bloqueado!',
    'user:block:error' => '¡No se puede bloquear el usuario! Por favor, inténtelo de nuevo más tarde.',
    'user:block' => 'Bloquear',
    'user:unblock' => 'Desbloquear',
    'user:unblocked' => 'El usuario ha sido desbloqueado',
