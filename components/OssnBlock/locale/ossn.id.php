 ...
 */
$id = array(
    'user:blocked' => 'Pengguna telah diblokir!',
    'user:block:error' => 'Tidak dapat memblokir pengguna! Silakan coba lagi nanti.',
    'user:block' => 'Blokir',
    'user:unblock' => 'Lepaskan Blokir',
    'user:unblocked' => 'Pengguna ini telah dilepas Blokir',
