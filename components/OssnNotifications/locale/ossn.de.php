...
$de = array(
    ...
    'ossn:notifications:comments:entity:file:profile:photo' => "%s hat dein Profilbild kommentiert.",
    'ossn:notifications:like:entity:file:profile:photo' => "%s gefällt dein Profilbild.",
    'ossn:notifications:like:post:group:wall' => '%s gefällt dein Beitrag',
	
    'ossn:notification:delete:friend' => 'Die Freundschaftsanfrage wurde gelöscht',
