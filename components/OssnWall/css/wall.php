...
.ossn-button-submit-b{
     ...
     background-image: linear-gradient(to bottom, #507C99, #3C5D73);filter:progid:DXImageTransform.Microsoft.gradient(GradientType=0,startColorstr=#507C99, endColorstr=#3C5D73);
}

.ossn-button-submit-b:hover{
 border:1px solid #2d4656;
 background-color: #38586B; background-image: -webkit-gradient(linear, left top, left bottom, from(#38586B), to(#2F495A));
 ...
 background-image: linear-gradient(to bottom, #38586B, #2F495A);filter:progid:DXImageTransform.Microsoft.gradient(GradientType=0,startColorstr=#38586B, endColorstr=#2F495A);
}
.ossn-wall-post {
width: 62px;
padding: 5px;
...
.ossn-wall-on {
 ...
 ul.token-input-list {
    ...
    color: #2B5470;
    font-wight:bold;
    border-top: 1px dashed #EEE; /** $arsalan.shah **/
}
